...
export class WalletAlreadyExistsException extends GrpcException {
  constructor() {
    super(ErrorMessage[ErrorCode.WALLET_ALREADY_EXISTS], GrpcStatus.ALREADY_EXISTS, ErrorCode.WALLET_ALREADY_EXISTS);
  }
}
...
export class InsufficientBalanceException extends GrpcException {
  constructor() {
    super(ErrorMessage[ErrorCode.INSUFFICIENT_BALANCE], GrpcStatus.FAILED_PRECONDITION, ErrorCode.INSUFFICIENT_BALANCE);
  }
}
